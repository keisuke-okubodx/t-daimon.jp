...
define("ace/lib/event", ["require", "exports", "module", "ace/lib/keys", "ace/lib/useragent"], function(e, t, n) {
    ...
    t.addMouseWheelListener = function(e, t, n) {
        "onmousewheel"in e ? c(e, "mousewheel", function(e) {
            var n = 8;
            e.wheelDeltaX !== undefined ? (e.wheelX = -e.wheelDeltaX / n,
    ...
    t.addTouchListeners = function(e, t) {
        ...
        i.addListener(e, "touchstart", function(e) {
            ...
            if (y - a < 500 && i.length == 1 && !h)
                ...
                _ < 3.5 ? n = "anchor" : M < 3.5 ? n = "cursor" : n = "scroll",
                l = setTimeout(S, 450)
            }
            a = y
        }, t),
        ...
        this.$renderToken = function(e, t, n, r) {
            ...
            while (a = o.exec(r)) {
                ...
                if (l) {
                    ...
                    g.className = i.showSpaces ? "ace_cjk ace_invisible" : "ace_cjk",
