ace.define("ace/snippets", ["require", "exports", "module", "ace/lib/oop", "ace/lib/event_emitter", "ace/lib/lang", "ace/range", "ace/range_list", "ace/keyboard/hash_handler", "ace/tokenizer", "ace/clipboard", "ace/lib/dom", "ace/editor"], function(e, t, n) {
  ...
  (function() {
      ...
      this.createTokenizer = function() {
          ...
          return p.$tokenizer = new f({
              start: [{
                  ...
                  onMatch: function(e, t, n) {
                      var r = e[1];
                      return r == "}" && n.length ? e = r : "`$\\".indexOf(r) != -1 && (e = r),
                      [e]
                  }
              }, {
                  regex: /}/,
              ...
              formatString: [{
                  regex: /:/,
                  onMatch: function(e, t, n) {
                      return n.length && n[0].expectElse ? (n[0].expectElse = !1,
                      n[0].ifEnd = {
                          elseEnd: n[0]
                      },
                      [n[0].ifEnd]) : ":"
              ...
              formatStringVar: [{
                  ...
                  onMatch: function(e, t, n) {
                      var r = n[0];
                      return r.formatFunction = e.slice(2, -1),
                      [n.shift()]
                  },
                  next: "formatString"
              }, n, {
      ...
      this.getVariableValue = function(e, t, n) {
          ...
          return typeof r == "function" && (r = this.variables[t](e, t, n)),
          r == null ? "" : r
      }
      ,
      this.variables = c,
              ...
              for (var i = 0; i < t.length; i++) {
                  ...
                  if (typeof u == "object") {
                      ...
                      if (u.changeCase && u.local) {
                          var a = t[i + 1];
                          a && typeof a == "string" && (u.changeCase == "u" ? t[i] = a[0].toUpperCase() : t[i] = a[0].toLowerCase(),
                          t[i + 1] = a.substr(1))
                      } else
      ...
      this.register = function(e, t) {
          ...
          function a(e) {
              ...
              !e.content && e.body && (e.content = Array.isArray(e.body) ? e.body.join("\n") : e.body),
          ...
          var n = this.snippetMap
            ...
            , i = this;
          e || (e = []),
          Array.isArray(e) ? e.forEach(a) : Object.keys(e).forEach(function(t) {
              a(e[t])
          }),
  ...
  (function() {
      ...
      this.selectTabstop = function(e) {
          ...
          if (!this.editor.inVirtualSelectionMode) {
              ...
              this.editor.selection.setRange(n);
          this.editor.keyBinding.addKeyboardHandler(this.keyboardHandler),
      ...
      this.addTabstops = function(e, t, n) {
          ...
          e.forEach(function(e, n) {
              ...
              for (var s = 0; s < e.length; s++) {
                  ...
                  l.fmtString || i.firstNonLinked && r ? (c.linked = !0,
          ...
          a.length > 2 && (this.tabstops.length && a.push(a.splice(2, 1)[0]),
...
ace.define("ace/autocomplete", ["require", "exports", "module", "ace/keyboard/hash_handler", "ace/autocomplete/popup", "ace/autocomplete/util", "ace/lib/lang", "ace/lib/dom", "ace/snippets", "ace/config"], function(e, t, n) {
  ...
  var r = e("./keyboard/hash_handler").HashHandler
    ...
    , l = function() {
      ...
      this.changeTimer = o.delayedCall(function() {
  ...
  (function() {
      ...
      this.updateCompletions = function(e, t) {
          ...
          if (t && t.matches) {
              ...
              return this.base = this.editor.session.doc.createAnchor(n.row, n.column),
              this.base.$insertRight = !0,
      ...
      this.showDocTooltip = function(e) {
          this.tooltipNode || (this.tooltipNode = u.createElement("div"),
  ...
  l.for = function(e) {
      return e.completer ? e.completer : (f.get("sharedPopups") ? (l.$shared || (l.$sharedInstance = new l),
      e.completer = l.$sharedInstance) : (e.completer = new l,
